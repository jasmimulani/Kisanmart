...
export const footerLinks = [
  {
    ...
    links: [
      ...
      { text: "Seasonal Fruits", url: "/products/fruits" },
      { text: "Organic Grains", url: "/products/grains" },
      { text: "Dairy & Eggs", url: "/products/dairy" },
      { text: "Herbs & Spices", url: "/products/herbs" },
    ],
  },
  {
    title: "Farmer Support",
    links: [
      { text: "Become a Seller", url: "/seller/register" },
      { text: "Farming Resources", url: "/resources" },
      { text: "Organic Certification", url: "/organic-certification" },
      { text: "Pricing & Commission", url: "/seller/pricing" },
      { text: "Farmer Login", url: "/seller/login" },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      { text: "Instagram", url: "https://instagram.com/kisanmart" },
      { text: "Facebook", url: "https://facebook.com/kisanmart" },
      { text: "Twitter", url: "https://twitter.com/kisanmart" },
      { text: "YouTube", url: "https://youtube.com/kisanmart" },
    ],
  },
];
...
export const features = [
  ...
  },
  {
    icon: leaf_icon,
    title: "100% Organic",
    description: "Naturally grown, chemical-free produce.",
  },
  {
    icon: coin_icon,
