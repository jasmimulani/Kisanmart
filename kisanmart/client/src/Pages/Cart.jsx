...
const Cart = () => {
  ...
  // If products haven't loaded yet, don't render the page
      ...
      {cartCount === 0 ? (
        <div className="flex flex-col items-center justify-center py-24">
          <img
            ...
            alt="Empty cart"
            className="w-36 h-36 opacity-70 mb-6"
          />
      ...
      <span>
        ...
        {getCartAmount()}
            ...
            <button
              ...
              className={`w-full py-3 mt-6 font-medium transition ${cartCount === 0 ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-primary text-white hover:bg-primary-dull'}`}
            >
